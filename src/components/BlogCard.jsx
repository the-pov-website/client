...
export default function BlogCard({ blog, onClick }) {
  ...
  return (
    <div
      ...
      className="border border-gray-100 rounded-xl p-6 hover:border-emerald-300 cursor-pointer"
    >
      ...
      <span className="inline-block bg-emerald-50 text-emerald-800 text-xs px-3 py-1 rounded-full mt-3">
        {blog.tag}
      </span>
    </div>
  );
